...
# Si usas IAM Role en las instancias EC2, comenta estas líneas
# IMPORTANTE: Las credenciales temporales expiran (típicamente 1 hora)
# Obtén nuevas credenciales desde la consola de AWS cuando expiren
AWS_ACCESS_KEY_ID=a
